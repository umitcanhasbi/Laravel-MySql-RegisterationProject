    ...
    <table class="table">
      ...
      <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          ...
          <?php else: ?>
            <a href="/doneTask/<?php echo e($task->id); ?>">
          ...
          <td style="text-align:center">
          <?php if(!$task->isdone): ?>
            <form method="POST" action="/editTask/<?php echo e($task->id); ?>" class="form-inline">
              <?php echo e(csrf_field()); ?>

              <label for="task"></label>
              <input type="text" class="form-control" id="task" name="task" value="<?php echo e($task->task); ?>">
          ...
          <?php endif; ?>
          <td style="text-align:center"><a href="/deleteTask/<?php echo e($task->id); ?>"><button type="button" name="edit" class="btn btn-danger">Delete</button></a></td>
        </tr>
